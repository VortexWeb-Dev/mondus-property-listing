...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const url = `${API_BASE_URL}crm.item.list?entityTypeId=${DEVELOPERS_ENTITY_ID}&select[0]=ID&select[1]=ufCrm11DeveloperName&order[ufCrm11DeveloperName]=asc`;
        ...
        const fetchAndDisplayOptions = async () => {
            try {
                ...
                developers.forEach(developer => {
                    ...
                    option.value = developer.ufCrm11DeveloperName;
                    option.textContent = developer.ufCrm11DeveloperName;
