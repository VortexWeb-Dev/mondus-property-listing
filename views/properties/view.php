...
<script>
    ...
    async function fetchProperty(id) {
        ...
        if (data.result && data.result.item) {
            ...
            document.getElementById('property-title').textContent = property.ufCrm15TitleEn || 'No title available';
            document.getElementById('property-description').innerHTML = '<pre>' + property.ufCrm15DescriptionEn + '</pre>' || 'No description available';
            document.getElementById('property-city').textContent = property.ufCrm15City || 'N/A';
            document.getElementById('property-community').textContent = property.ufCrm15Community || 'N/A';
            let priceText = property.ufCrm15Price ? formatPrice(property.ufCrm15Price) : 'N/A';
            if (property.ufCrm15RentalPeriod && property.ufCrm15RentalPrice) {
                ...
                const rentalPeriod = rentalPeriodMapping[property.ufCrm15RentalPrice] || property.ufCrm15RentalPeriod;
                priceText += `/ ${rentalPeriod}`;
            }
            document.getElementById('property-price').textContent = priceText;
            document.getElementById('property-size').textContent = property.ufCrm15Size ? `${property.ufCrm15Size} sqft` : 'N/A';
            document.getElementById('property-bedrooms').textContent = property.ufCrm15Bedroom || 'N/A';
            document.getElementById('property-bathrooms').textContent = property.ufCrm15Bathroom || 'N/A';
            document.getElementById('property-type').textContent = property.ufCrm15PropertyType || 'N/A';
            document.getElementById('property-location').textContent = property.ufCrm15Location || 'N/A';
            document.getElementById('property-status').textContent = property.ufCrm15Status || 'N/A';
            document.getElementById('property-owner').textContent = property.ufCrm15ListingOwner || 'N/A';
            document.getElementById('agent-name').textContent = property.ufCrm15AgentName || 'N/A';
            document.getElementById('agent-phone').textContent = property.ufCrm15AgentPhone || 'N/A';
            document.getElementById('agent-email').textContent = property.ufCrm15AgentEmail || 'N/A';
            document.getElementById('main-image').src = property.ufCrm15PhotoLinks[0] || 'https://placehold.jp/150x150.png';

            const images = property.ufCrm15PhotoLinks || [];
            ...
            const comments = property.ufCrm15Notes || [];
