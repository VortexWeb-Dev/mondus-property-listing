    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const searchItems = (query) => {
            ...
            const data = {
                ...
                "select": ["id", "ufCrm13SubCommunity"], // Updated field name
                "filter": {
                    "%ufCrm13SubCommunity": query // Updated field name in filter
                }
            };
            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueSubCommunities.has(item.ufCrm13SubCommunity)) {
                                uniqueSubCommunities.add(item.ufCrm13SubCommunity);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm13SubCommunity;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm13SubCommunity;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
