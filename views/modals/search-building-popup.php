    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const searchItems = (query) => {
            ...
            const data = {
                ...
                "select": ["id", "ufCrm13Building"], // Updated field name
                "filter": {
                    "%ufCrm13Building": query // Updated field name in filter
                }
            };
            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueBuildings.has(item.ufCrm13Building)) {
                                uniqueBuildings.add(item.ufCrm13Building);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm13Building;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm13Building;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
