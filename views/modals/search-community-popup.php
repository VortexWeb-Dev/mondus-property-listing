    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const searchItems = (query) => {
            ...
            const data = {
                ...
                "select": ["id", "ufCrm13Community"], // Updated field name
                "filter": {
                    "%ufCrm13Community": query // Updated field name in filter
                }
            };
            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueCommunities.has(item.ufCrm13Community)) {
                                uniqueCommunities.add(item.ufCrm13Community);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm13Community;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm13Community;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
