            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueCities.has(item.ufCrm13City)) {
                                uniqueCities.add(item.ufCrm13City);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm13City;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm13City;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
