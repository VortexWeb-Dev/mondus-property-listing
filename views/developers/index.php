...
<script>
    ...
    async function fetchDevelopers(page = 1) {
        ...
        const apiUrl = `${baseUrl}/crm.item.list?entityTypeId=${DEVELOPERS_ENTITY_ID}&order[id]=desc&select[0]=id&select[1]=ufCrm11DeveloperName&start=${(page - 1) * pageSize}`;
        ...
        try {
            ...
            developerList.innerHTML = developers
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">${developer.ufCrm11DeveloperName || 'N/A'}</td>
