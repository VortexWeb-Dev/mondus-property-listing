...
<script>
    ...
    async function fetchLocations(page = 1) {
        ...
        const apiUrl = `${baseUrl}/crm.item.list?entityTypeId=${entityTypeId}&order[id]=desc&select[0]=id&select[1]=ufCrm12Location&start=${(page - 1) * pageSize}`;
        ...
        try {
            ...
            locationList.innerHTML = locations
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">${location.ufCrm12Location || 'N/A'}</td>
